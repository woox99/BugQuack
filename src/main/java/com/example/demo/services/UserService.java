...
public class UserService {
    ...
    public User register(User newUser, BindingResult result) {
    	...
    	// Set first and last name to upper case
    	String firstName = newUser.getFirstName();
    	String lastName = newUser.getLastName();
    	newUser.setFirstName(firstName.substring(0, 1).toUpperCase() + firstName.substring(1).toLowerCase());
    	newUser.setLastName(lastName.substring(0, 1).toUpperCase() + lastName.substring(1).toLowerCase());
